...
#os.system ("clear")
def usage():
    print("ADM-CCGen+.py version:{}".format(version))
    print("")
    print("\033[1;31m               +------------------------------+")
    print("               +\033[1;32m   GENERADOR DE BIN ADM-PLUS  \033[1;31m+")
    print("               +------------------------------+")
    print("")
    print("+---------------+")
    ...
    print("+---------------+")
    print("")
    print("\033[1;34m     python2 ADM-CCGen+.py -b     [Opciones de uso]")
    print("     python2 ADM-CCGen+.py -h     Mensaje de ayuda")
    print("\033[1;31m")
    print("+-----------------+")
    print("+\033[1;32m Opciones de uso\033[1;31m +")
    print("+-----------------+")
    print("")
    print("\033[1;34m     -b, -bin          Formato de bin")
    ...
    print("\033[1;31m")
    print("+----------------+")
    print("+\033[1;32m Ejemplo de uso\033[1;31m +")
    print("+----------------+")
    print("")
    print("\033[1;33m     CANTIDAD 20\033[0m")
    print("")
    print("\033[1;34m     python2 ADM-CCGen+.py -b 406032xxxxxxxxxx -u 20 -d -c ")
    print("")
    print("\033[0m")
    print("\033[1;31m")
    print("+----------------+")
    print("+\033[;32m Hecho Por:    \033[1;31m +")
    print("+\033[;32m @Thony_DroidYT\033[1;31m +")
    print("+----------------+")
    print("")
    print("\033[1;33m     Creditos:\033[0m")
    print("")
    print("\033[1;34m     @e8th4ever")
    print("\033[1;34m     @RealStrategy")
    print("\033[1;34m     @IluminatiCorps")
    print("")
    print("\033[0m")
...
def parseOptions(argv):
    ...
    try:
        ...
        return(bin_format, saveopt, limit, date, ccv)
...
def main(argv):
    ...
    if bin_format is not "":
        ...
        if not bin_list:
        	...
        	print("\nGeneradas: Con Éxito ")
        	print("\nTarjetas Generadas: Con ADM-CCGen+ ")
        if saveopt:
            save(bin_list)
    else:
        usage()
