...
echo
msg -ama " $(fun_trans "INSTALADO SSL").. "
inst_ssl () {
pkill -f stunnel4
pkill -f stunnel
pkill -f 443
...
(echo pe; echo peru; echo uss; echo speed; echo peru; echo ADMPlus; echo @Thony_DroidYT)|openssl req -new -x509 -key key.pem -out cert.pem -days 1095 > /dev/null 2>&1
...
fun_bar2 'inst_ssl'
msg -ama " $(fun_trans "CONFIGURANDO PYTHON").. "
inst_py () {
