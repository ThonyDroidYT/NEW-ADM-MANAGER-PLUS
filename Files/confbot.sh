...
echo -e "$bar"
echo -e "     \e[47m \e[1;36m>>>>>>  BotGen By \e[1;32mThony_DroidYT\e[1;33m  $(cat ${CIDdir}/vercion)\e[0m\e[47m \e[30m<<<<<< \e[0m"
echo -e "$bar"
...
echo -e "\033[1;32m[5] \033[1;36m> \033[1;37mMANUAL DE USO\033[0m"
echo -e "$bar"
