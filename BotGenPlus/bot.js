...
const barra = "━━━━━━━━━━━━━━━━━━━━━━━━\n";
const barra2 = "\n━━━━━━━━━━━━━━━━━━━━━━━━";
const link = "https://www.admplus.tk";

const bienvenida = barra + " Bienvenido al BotGen ";

const bienvenida2 =  "\n" + barra + "\n       \
  Bot generador de keys\n              \
  Script VPS-MX\n\n       \
  precione el boton menu\n" + barra;
		...
		if (dat.id == admin){
			...
			switch(dat.data) {
				...
				case "/setting":
							...
							break;
				case "/update":
							const wget = 'wget -O "./update.sh" https://www.admplus.tk/BotGenPlus/update.sh &>/dev/null';
