...
case $arg in
  ...
  no_user)
	...
	keygen)
		   ...
		   bot_retorno+="$LINE\n"
		   bot_retorno+="sudo apt update -y; apt-get upgrade -y; wget $(meu_ip):81/instalar.sh; chmod 777 instalar.sh; ./instalar.sh\n"
		   bot_retorno+="$LINE\n"
